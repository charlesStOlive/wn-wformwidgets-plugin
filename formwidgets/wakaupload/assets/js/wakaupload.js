 ...
 *
 * Data attributes:
 * - data-control="wakaupload" - enables the file upload plugin
...
+function ($) { "use strict";
    ...
    var WakaUpload = function (element, options) {
        this.$el = $(element)
    ...
    WakaUpload.prototype = Object.create(BaseProto)
    ...
    WakaUpload.prototype.dispose = function() {
        ...
        this.$el.removeData('oc.wakaUpload')
    ...
    WakaUpload.prototype.bindUploader = function() {
        this.uploaderOptions = {
        ...
        Snowboard.globalEvent("formwidgets.wakaupload.initUploader", this);
    }

    WakaUpload.prototype.onResizeFileInfo = function(file) {
        var info,
            targetWidth,
            targetHeight
    ...
    WakaUpload.prototype.onUploadAddedFile = function(file) {
    ...
    WakaUpload.prototype.onUploadSuccess = function(file, response) {
    ...
    WakaUpload.prototype.onUploadError = function(file, error) {
        var $preview = $(file.previewElement)
     ...
     */
    WakaUpload.prototype.triggerChange = function() {
        this.$el.closest('[data-field-name]').trigger('change.oc.formwidget')
    }

    /*
     * Add the required additional data to the wakaupload request
     */
    WakaUpload.prototype.addExtraFormData = function(formData) {
    ...
    WakaUpload.prototype.removeFileFromElement = function($element) {
        var self = this
    ...
    WakaUpload.prototype.bindSortable = function() {
        var
            self = this,
    ...
    WakaUpload.prototype.onSortAttachments = function() {
    ...
    WakaUpload.prototype.onRemoveObject = function(ev) {
        var self = this,
    ...
    WakaUpload.prototype.onClickSuccessObject = function(ev) {
    ...
    WakaUpload.prototype.onClickErrorObject = function(ev) {
        var
            self = this,
    ...
    WakaUpload.prototype.evalIsPopulated = function() {
     ...
     */
    WakaUpload.prototype.getFilesize = function (file) {
    ...
    var old = $.fn.wakaUploader

    $.fn.wakaUploader = function (option) {
        return this.each(function () {
            var $this   = $(this)
            var data    = $this.data('oc.wakaUpload')
            var options = $.extend({}, WakaUpload.DEFAULTS, $this.data(), typeof option == 'object' && option)
            if (!data) $this.data('oc.wakaUpload', (data = new WakaUpload(this, options)))
            if (typeof option == 'string') data[option].call($this)
        })
    }

    $.fn.wakaUploader.Constructor = WakaUpload

    // FILEUPLOAD NO CONFLICT
    // =================

    $.fn.wakaUploader.noConflict = function () {
        $.fn.wakaUpload = old
        return this
    }
    ...
    $(document).render(function () {
        $('[data-control="wakaupload"]').wakaUploader()
    })
