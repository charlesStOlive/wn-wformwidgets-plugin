 ...
 */
class AdvancedMediaFinder extends FormWidgetBase
{
    //
     ...
     */
    public $prompt = 'waka.wformwidgets::lang.advancedmediafinder.default_prompt';
    ...
    public function render()
    {
        ...
        return $this->makePartial('advancedmediafinder');
    }
    ...
    protected function loadAssets()
    {
        ...
        $this->addJs('js/advancedmediafinder.js', 'waka.wformwidgets');
        $this->addCss('css/advancedmediafinder.css', 'waka.wformwidgets');
    }
}
