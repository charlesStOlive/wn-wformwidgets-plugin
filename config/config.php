...
return [
    'froala' => [
        'html_toolbar_buttons' => [
            'full' => 'myButton,undo,redo,bold,italic,underline,paragraphFormat,paragraphStyle,inlineStyle,strikeThrough,subscript,superscript,clearFormatting,fontFamily,fontSize,color,emoticons,-,selectAll,align,formatOL,formatUL,outdent,indent,quote,insertHR,insertLink,insertImage,insertVideo,insertAudio,insertFile,insertTable,selectAll,html,fullscreen',
            'minimal' => 'undo,redo,bold,italic,underline,strikeThrough,subscript,superscript,',
            'minimalist' => 'bold,italic',
            'default' => 'link,undo,redo,bold,italic,underline,subscript,superscript,paragraphFormat,clearFormatting,color,selectAll,align,formatOL,formatUL,outdent,indent,quote,insertHR,html,fullscreen',
